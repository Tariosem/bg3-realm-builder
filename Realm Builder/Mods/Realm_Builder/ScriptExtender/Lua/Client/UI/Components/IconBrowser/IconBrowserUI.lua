...
function IconBrowser:RenderUiConfigMenu()
    ...
    local browserWidthSlider = SafeAddSliderInt(self.uiParamMenu, GetLoca("Image Per Row"), imagePerRow, 4, 20)
    local browserHeightSlider = SafeAddSliderInt(self.uiParamMenu, GetLoca("Image Per Column"), imagePerCol, 4, 20)
