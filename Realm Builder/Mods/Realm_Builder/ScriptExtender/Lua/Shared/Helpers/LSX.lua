...
function LSXUtils.new()
    ...
    local lsxRoot = LSXNode.new("save"):AppendChild(
        LSXNode.new("version", {
    ...
    lsxRoot:GetChild(1):SetAttrOrder({"major", "minor", "revision", "build", "lslib_meta"})
    ...
    lsxRoot:AddComment("This file was generated by Script Extender")
...
---@return LSXNode
function LSXUtils.RegionNodeWrapper(regionName, parent)
...
---@param value any
---@return LSXNode
function LSXUtils.AttrNode(id, type, value)
